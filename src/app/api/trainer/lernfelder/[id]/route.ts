...
export async function GET(
    ...
    try {
        ...
        const relatedUseCases = allUseCases.filter(u => u.lernfelder && Array.isArray(u.lernfelder) && u.lernfelder.includes(row.label));
...
export async function PATCH(
    ...
    try {
        ...
        const [updated] = await db.update(lernfelderSchema)
            .set({
