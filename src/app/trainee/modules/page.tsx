    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="glass-effect rounded-3xl p-8 shadow-lg border border-accent/30">
        <div className="flex items-center gap-6 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Lernmodule</h1>
          ...
          <div key={module.moduleId} className="glass-effect rounded-3xl p-6 shadow-lg border border-accent/30 hover:shadow-xl transition-all duration-300">
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between text-sm mb-2">
                ...
                <span className="font-medium text-foreground">{module.progress || 0}%</span>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
              <div className="text-center p-3 bg-background/50 rounded-xl">
                <div className="text-lg font-bold text-accent">{module.chapters?.length || 0}</div>
              ...
              <div className="text-center p-3 bg-background/50 rounded-xl">
                <div className="text-lg font-bold text-accent">{module.chapters?.reduce((total, chapter) => total + (chapter.lessons?.length || 0), 0) || 0}</div>
