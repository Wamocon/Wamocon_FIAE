          ...
          {gated.map(g => {
            ...
            return (
              <button
                ...
                className={`rounded-2xl border p-4 text-left transition ${disabled ? 'cursor-not-allowed border-accent bg-background/20 opacity-60' : 'border-accent bg-background hover:bg-background/50'}`}
                disabled={disabled}
              >
