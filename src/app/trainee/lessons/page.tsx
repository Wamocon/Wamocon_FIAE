    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="glass-effect rounded-3xl p-8 shadow-lg border border-accent/30">
        <div className="flex items-center gap-6 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Alle Lektionen</h1>
            <p className="text-muted">Übersicht über alle verfügbaren Lektionen in Ihren Modulen</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {allLessons.map((lesson) => (
          <div key={lesson.id} className="glass-effect rounded-3xl p-6 shadow-lg border border-accent/30 hover:shadow-xl transition-all duration-300">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl text-foreground">{lesson.title}</h3>
            ...
            <p className="text-muted mb-4 line-clamp-2">{lesson.ref || 'Keine Beschreibung verfügbar'}</p>
            
            {/* Progress */}
            <div className="mb-4">
                          <div className="flex items-center justify-between text-sm mb-2">
              <span className="text-muted">Status</span>
              <span className="font-medium text-foreground">{lesson.completed ? 'Abgeschlossen' : 'Nicht begonnen'}</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
              ...
              <div className="text-center p-3 bg-background/50 rounded-xl">
                <div className="text-lg font-bold text-primary">{lesson.type}</div>
