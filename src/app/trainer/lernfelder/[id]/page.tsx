...
import { ArrowLeft, BookOpen, Clock, Layers, Edit2, Trash2, X, ArrowRight, FileText, Tag } from 'lucide-react';
...
export default function TrainerLernfeldDetailPage() {
    ...
    const handleLernfeldClick = (e: React.MouseEvent, label: string) => {
        ...
        if (lf) {
            router.push(`/trainer/lernfelder/${lf.id}`);
        }
    };
