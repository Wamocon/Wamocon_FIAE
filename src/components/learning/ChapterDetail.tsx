...
import { BookOpen, Edit3, FileQuestion, CheckCircle2, Circle, Loader2 } from 'lucide-react'
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="glass-effect rounded-3xl p-8 shadow-lg border border-accent/30">
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">{mockChapter.title}</h1>
          <p className="text-muted">Kapitel aus dem Modul "Grundlagen der Anwendungsentwicklung"</p>
        </div>
      </div>

      {/* Lessons List */}
      <div className="glass-effect rounded-3xl p-8 shadow-lg border border-accent/30">
        <h2 className="text-2xl font-bold text-foreground mb-6">Lektionen in diesem Kapitel</h2>
      ...
      {/* Quiz Section */}
      <div className="glass-effect rounded-3xl p-8 border border-accent/30 cursor-pointer hover:border-accent/50 hover:shadow-lg transition-all duration-200"
           onClick={() => handleQuizClick(mockChapter.mainQuizId)}>
        <div className="flex items-center justify-between">
          <div>
            <h4 className="font-bold text-2xl text-foreground mb-2">Abschlusstest: {mockChapter.title}</h4>
