...
export function ContentArea({ currentView, profile, onNavigation }: ContentAreaProps) {
        ...
        return (
          <div className="text-center text-gray-500 p-8">
            <div className="max-w-md mx-auto">
              ...
              <h2 className="text-2xl font-semibold text-gray-300 mb-2">Diese Ansicht befindet sich im Aufbau</h2>
              <p className="text-gray-500">Bitte wählen Sie eine andere Option aus dem Menü.</p>
            </div>
          </div>
        )
    }
